  ...
  ({ Icon, label, ...props }, ref) => {
    return (
      <button
        ref={ref}
        {...props}
        className="flex gap-2 items-center justify-center bg-blue-500 text-white font-semibold py-2 px-4 hover:bg-blue-600 transition-colors rounded-[32px] flex-1 min-w-40"
      >
